...
//!
//! A giant [whale](https://en.wikipedia.org/wiki/Sperm_whale) has decided your submarine is its
//! next meal, and it's much faster than you are. There's nowhere to run!
//!
...
//! change of 1 step in horizontal position costs 1 more unit of fuel than the last: the first step
...
// named after nightly-only u32::abs_diff:
