...
//! lanternfish might have 2 days left until it creates another lanternfish, while another might
//! have 4. So, you can model each fish as a single number that represents the number of days
