...
//! each line is a measurement of the sea floor depth as the sweep looks further and further
...
//! its sum is `618`. The sum of measurements in the second window is larger than the sum
